...
public class CustomizationController {
    ...
    void onCellStyleChanged(ActionEvent event) {
        this.mainViewController.setCellStyle(
    ...
    void onCenterAlignmentClicked(ActionEvent event) {
        this.mainViewController.setColumnTextAlignment(this.columnNameProperty.get(), "center");
    }
    
    @FXML
    void onLeftAlignmentClicked(ActionEvent event) {
        this.mainViewController.setColumnTextAlignment(this.columnNameProperty.get(), "left");
        
    }
    
    @FXML
    void onRightAlignmentClicked(ActionEvent event) {
        this.mainViewController.setColumnTextAlignment(this.columnNameProperty.get(), "right");
    }
