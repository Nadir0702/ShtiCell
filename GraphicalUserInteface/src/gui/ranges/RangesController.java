...
public class RangesController {
    ...
    private void initialize() {
        ...
        this.rangesListView.setOnMouseClicked(event -> {
            ...
            this.mainViewController.toggleSelectedRange(selectedRange, this.rangesModel.getSelectedRange());
            ...
            if (!newValue) {
                ...
                pause.setOnFinished(event -> {
                    ...
                    if (!this.rangesListView.isFocused()) {
                        this.mainViewController.toggleSelectedRange(null, this.rangesModel.getSelectedRange());
    ...
    void onDeleteRangeClicked(ActionEvent event) {
        ...
        if (rangeToDelete != null && this.mainViewController.deleteRange(rangeToDelete)) {
    ...
    void onSaveRangeClicked(ActionEvent event) {
        RangeDTO newRange = this.mainViewController.addNewRange(
